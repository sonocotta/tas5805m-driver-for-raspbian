...
//RESET
    ...
    { 0x5e, 0x57 },
    { 0x5f, 0x62 },
    { 0x60, 0x01 }, //  AGL Attack Rate: 0.5
    { 0x61, 0x56 },
    { 0x62, 0x04 },
    { 0x63, 0x19 },
    { 0x64, 0x06 }, //  AGL Threshold: -2 dB
    { 0x65, 0x5a },
    { 0x66, 0xc8 },
    { 0x67, 0xc3 },
    ...
    { 0x6a, 0x00 },
    { 0x6b, 0x00 },
    { 0x6c, 0x01 }, //  AGL Softening Alpha: 0.9 ms
    { 0x6d, 0x79 },
    { 0x6e, 0x12 },
    { 0x6f, 0xab },
    ...
    { 0x77, 0x00 },
    { 0x00, 0x2d },
    { 0x18, 0x7e }, //  AGL Softening Omega: 0.9 ms
    { 0x19, 0x86 },
    { 0x1a, 0xed },
    { 0x1b, 0x55 },
    ...
    { 0x2f, 0x00 },
    { 0x00, 0x2a },
    { 0x48, 0x00 }, //  Low F2 BQ2   -     Filter: Low Pass-ButterWorth 2  Frequency: 250 Hz  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x49, 0x02 },
    { 0x4a, 0x2b },
    { 0x4b, 0x09 },
    { 0x4c, 0x00 },
    ...
    { 0x7f, 0x8c },
    { 0x00, 0x2b },
    { 0x34, 0x00 }, //   DRC Settings of band1:   attack: 25 ms, release: 50 ms, energy: 25 ms, Region1 - Threshold: -124 dB, Offset: 19.308 dB, Ratio: 1.3   Region2 - Threshold: -75 dB, Offset: 8 dB, Ratio: 1.12   Region3 - Threshold: 0 dB, Offset: 0 dB, Ratio: 1
    { 0x35, 0x0d },
    { 0x36, 0xa6 },
    { 0x37, 0x86 },
    { 0x38, 0x00 },
    ...
    { 0x5b, 0x00 },
    { 0x00, 0x2d },
    { 0x58, 0x01 }, //   DRC Settings of band3:   attack: 1 ms, release: 10 ms, energy: 1 ms, Region1 - Threshold: -124 dB, Offset: 9.455 dB, Ratio: 1.1   Region2 - Threshold: -75 dB, Offset: 5 dB, Ratio: 1.07   Region3 - Threshold: 0 dB, Offset: 0.093 dB, Ratio: 1.01
    { 0x59, 0x53 },
    { 0x5a, 0x8f },
    { 0x5b, 0xcc },
    { 0x5c, 0x01 },
    ...
    { 0x1f, 0x5a },
    { 0x00, 0x2a },
    { 0x34, 0x00 }, //  Low F1 BQ1   -     Filter: Low Pass-ButterWorth 2  Frequency: 250 Hz  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x35, 0x02 },
    { 0x36, 0x2b },
    { 0x37, 0x09 },
    { 0x38, 0x00 },
    ...
    { 0x7f, 0xaa },
    { 0x00, 0x2a },
    { 0x5c, 0x7e }, //  Mid F1 BQ1   -     Filter: High Pass-ButterWorth 2  Frequency: 250 Hz  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x5d, 0x87 },
    { 0x5e, 0x0f },
    { 0x5f, 0x08 },
    { 0x60, 0x81 },
    ...
    { 0x6e, 0x8b },
    { 0x6f, 0xdc },
    { 0x70, 0x7e }, //  Mid F2 BQ2   -     Filter: High Pass-ButterWorth 2  Frequency: 250 Hz  QVal: 0.71  Bandwidth: 1000 Hz
    { 0x71, 0x87 },
    { 0x72, 0x0f },
    { 0x73, 0x08 },
    { 0x74, 0x81 },
