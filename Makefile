...
# CFLAGS_tas5805m.o += -DTAS5805M_DSP_STEREO_DRC
# CFLAGS_tas5805m.o += -DTAS5805M_DSP_STEREO_DRC_AGL
# CFLAGS_tas5805m.o += -DTAS5805M_DSP_MONO
# CFLAGS_tas5805m.o += -DTAS5805M_DSP_MONO_DRC
# CFLAGS_tas5805m.o += -DTAS5805M_DSP_MONO_DRC_AGL
...
# CFLAGS_tas5805m.o += -DTAS5805M_DSP_BIAMP
