...
//RESET
    ...
    { 0x7f, 0xaa },
    { 0x00, 0x24 },
    { 0x18, 0x07 }, //  Biquad -  BQ1 Left   -     Filter: Equalizer (Q Factor)  Frequency: 20 Hz  Gain: -5dB  QVal: 2  Bandwidth: 1000 Hz
    { 0x19, 0xff },
    { 0x1a, 0x7a },
    { 0x1b, 0x8c },
    { 0x1c, 0xf0 },
    ...
    { 0x2a, 0x61 },
    { 0x2b, 0xdb },
    { 0x2c, 0x07 }, //  Biquad -  BQ2 Left   -     Filter: Equalizer (Q Factor)  Frequency: 31.5 Hz  Gain: -5dB  QVal: 2  Bandwidth: 1000 Hz
    { 0x2d, 0xff },
    { 0x2e, 0x2d },
    { 0x2f, 0xe1 },
    { 0x30, 0xf0 },
    ...
    { 0x3e, 0xc0 },
    { 0x3f, 0x33 },
    { 0x40, 0x07 }, //  Biquad -  BQ3 Left   -     Filter: Equalizer (Q Factor)  Frequency: 50 Hz  Gain: -5dB  QVal: 1.5  Bandwidth: 1000 Hz
    { 0x41, 0xfe },
    { 0x42, 0x43 },
    { 0x43, 0xc2 },
    { 0x44, 0xf0 },
    ...
    { 0x52, 0xee },
    { 0x53, 0x18 },
    { 0x54, 0x07 }, //  Biquad -  BQ4 Left   -     Filter: Equalizer (Q Factor)  Frequency: 80 Hz  Gain: -5dB  QVal: 1.5  Bandwidth: 1000 Hz
    { 0x55, 0xfd },
    { 0x56, 0x3a },
    { 0x57, 0x09 },
    { 0x58, 0xf0 },
    ...
    { 0x66, 0xac },
    { 0x67, 0x61 },
    { 0x68, 0x07 }, //  Biquad -  BQ5 Left   -     Filter: Equalizer (Q Factor)  Frequency: 125 Hz  Gain: -5dB  QVal: 1  Bandwidth: 1000 Hz
    { 0x69, 0xf9 },
    { 0x6a, 0x86 },
    { 0x6b, 0xe9 },
    { 0x6c, 0xf0 },
    ...
    { 0x7a, 0x94 },
    { 0x7b, 0x87 },
    { 0x7c, 0x07 }, //  Biquad -  BQ6 Left   -     Filter: Equalizer (Q Factor)  Frequency: 200 Hz  Gain: -5dB  QVal: 1  Bandwidth: 1000 Hz
    { 0x7d, 0xf5 },
    { 0x7e, 0xb0 },
    { 0x7f, 0x18 },
    { 0x00, 0x25 },
    ...
    { 0x16, 0x1f },
    { 0x17, 0xc5 },
    { 0x18, 0x07 }, //  Biquad -  BQ7 Left   -     Filter: Equalizer (Q Factor)  Frequency: 315 Hz  Gain: -5dB  QVal: 0.9  Bandwidth: 1000 Hz
    { 0x19, 0xee },
    { 0x1a, 0x1b },
    { 0x1b, 0xaf },
    { 0x1c, 0xf0 },
    ...
    { 0x2a, 0xc2 },
    { 0x2b, 0xfe },
    { 0x2c, 0x07 }, //  Biquad -  BQ8 Left   -     Filter: Equalizer (Q Factor)  Frequency: 500 Hz  Gain: -5dB  QVal: 0.9  Bandwidth: 1000 Hz
    { 0x2d, 0xe3 },
    { 0x2e, 0xed },
    { 0x2f, 0xe7 },
    { 0x30, 0xf0 },
    ...
    { 0x3e, 0x46 },
    { 0x3f, 0xd1 },
    { 0x40, 0x07 }, //  Biquad -  BQ9 Left   -     Filter: Equalizer (Q Factor)  Frequency: 800 Hz  Gain: -5dB  QVal: 0.8  Bandwidth: 1000 Hz
    { 0x41, 0xce },
    { 0x42, 0xb5 },
    { 0x43, 0x2e },
    { 0x44, 0xf0 },
    ...
    { 0x52, 0x41 },
    { 0x53, 0x20 },
    { 0x54, 0x07 }, //  Biquad -  BQ10 Left   -     Filter: Equalizer (Q Factor)  Frequency: 1250 Hz  Gain: -5dB  QVal: 0.8  Bandwidth: 1000 Hz
    { 0x55, 0xb5 },
    { 0x56, 0x4a },
    { 0x57, 0xb7 },
    { 0x58, 0xf1 },
    ...
    { 0x66, 0x66 },
    { 0x67, 0x2f },
    { 0x68, 0x07 }, //  Biquad -  BQ11 Left   -     Filter: Equalizer (Q Factor)  Frequency: 2000 Hz  Gain: -5dB  QVal: 0.7  Bandwidth: 1000 Hz
    { 0x69, 0x80 },
    { 0x6a, 0x37 },
    { 0x6b, 0x39 },
    { 0x6c, 0xf2 },
    ...
    { 0x7a, 0xf1 },
    { 0x7b, 0xe9 },
    { 0x7c, 0x07 }, //  Biquad -  BQ12 Left   -     Filter: Equalizer (Q Factor)  Frequency: 3150 Hz  Gain: -5dB  QVal: 0.7  Bandwidth: 1000 Hz
    { 0x7d, 0x45 },
    { 0x7e, 0xfc },
    { 0x7f, 0xef },
    { 0x00, 0x26 },
    ...
    { 0x16, 0x08 },
    { 0x17, 0x3d },
    { 0x18, 0x06 }, //  Biquad -  BQ13 Left   -     Filter: Equalizer (Q Factor)  Frequency: 5000 Hz  Gain: -5dB  QVal: 0.6  Bandwidth: 1000 Hz
    { 0x19, 0xdb },
    { 0x1a, 0x47 },
    { 0x1b, 0xef },
    { 0x1c, 0xf5 },
    ...
    { 0x2a, 0xa8 },
    { 0x2b, 0xab },
    { 0x2c, 0x06 }, //  Biquad -  BQ14 Left   -     Filter: Equalizer (Q Factor)  Frequency: 8000 Hz  Gain: -5dB  QVal: 0.6  Bandwidth: 1000 Hz
    { 0x2d, 0x78 },
    { 0x2e, 0x62 },
    { 0x2f, 0x91 },
    { 0x30, 0xf8 },
    ...
    { 0x3e, 0x97 },
    { 0x3f, 0x3f },
    { 0x40, 0x05 }, //  Biquad -  BQ15 Left   -     Filter: Equalizer (Q Factor)  Frequency: 16000 Hz  Gain: -5dB  QVal: 0.5  Bandwidth: 1000 Hz
    { 0x41, 0xb8 },
    { 0x42, 0xd5 },
    { 0x43, 0x5a },
    { 0x44, 0xfd },
